...
\begin{frame}[fragile]
\frametitle{Your Turn}
Practice with images by inserting an image into the markdown document manually.\bigskip

If you don't have a favorite image, try \href{figure/Dogshaming.jpg}{this one}
\begin{center}
