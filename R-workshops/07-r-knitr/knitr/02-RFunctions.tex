...
produces the output $x=15$ and $\overline{y}=1.3513$ when compiled in a knitr document. As long as the code chunk you are referencing \textbf{precedes} the \texttt{\textbackslash Sexpr\{\}} command, knitr will be able to fill in the blanks for you!
...
% Date and time: Thu, Mar 06, 2014 - 12:59:46 PM
...
R$^{2}$ & 0.948 \\ 
Adjusted R$^{2}$ & 0.945 \\ 
Residual Std. Error & 0.826 (df = 19) \\ 
F Statistic & 345.700$^{***}$ (df = 1; 19) \\ 
\hline 
\hline \\[-1.8ex] 
...
\end{kframe}
% Table created by stargazer v.5.0 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Thu, Mar 06, 2014 - 01:03:44 PM
\begingroup 
\scriptsize 
...
\hline \\[-1.8ex] 
 x & 1.107$^{***}$ (0.060) & 1.041$^{***}$ (0.031) \\ 
  Constant & $-$0.448 (0.348) &  \\ 
 \hline \\[-1.8ex] 
Observations & 21 & 21 \\ 
R$^{2}$ & 0.948 & 0.982 \\ 
Adjusted R$^{2}$ & 0.945 & 0.981 \\ 
Residual Std. Error & 0.826 (df = 19) & 0.840 (df = 20) \\ 
F Statistic & 345.700$^{***}$ (df = 1; 19) & 1,104.000$^{***}$ (df = 1; 20) \\ 
\hline 
\hline \\[-1.8ex] 
...
\hline
Intercept&-0.448&0.348\tabularnewline
x&1.107&0.06\tabularnewline
\hline
