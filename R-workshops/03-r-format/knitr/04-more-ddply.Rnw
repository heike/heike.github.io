...
\includegraphics[keepaspectratio=TRUE,width=.97\linewidth]{figure/Stringr}
\end{frame}
...
{\small\url{http://www.stat.iastate.edu/centers/CCGS/R\%20workshops/03-r-format/data/OkCupid.csv}}
