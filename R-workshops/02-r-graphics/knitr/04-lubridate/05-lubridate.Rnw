...
\title[ 4-Graphics]{4 - Advanced Graphics}
\subtitle{Dates, Times, and Groups}
\author[ K. Maurer, S. VanderPlas]{Karsten Maurer and Susan VanderPlas}
...
nasa <- read.csv("/home/susan/Dropbox/GraphicsGroup/R workshops/02-r-graphics/data/04-data/nasadata.csv")
library(maps)
library(mapdata)
